...
namespace G3X
{
	...
	u32 LoadTextureToVram(char* texData, u32 texSize); // returns vram offset
	u32 GetVramOffset(u32 texSize); // of UNCOMPRESSED texture
	u32 LoadCompressedTextureToVram(char* texData, u32 texSize, char* indexData); // returns vram offset
}
