...
extern Fix12s CHAR_ATTACK_KNOCKBACK[Player::NUM_CHARACTERS + 1]; // 5 is for Metal Wario
extern u8 STUCK_IN_GROUND_LEAVE_ANIM_FRAMES[3];
extern s8 CHAR_GROUP_ID[Player::NUM_CHARACTERS];
extern s8 CHAR_BGM_GROUP_ID[Player::NUM_CHARACTERS];
extern u32 DIVE_VOICE_IDS[2];
extern u16 CHAR_FIRST_CHANGE_ANIM_MESSAGE_FRAME[Player::NUM_CHARACTERS];
extern u32 OPEN_DOOR_ANIM_IDS[2];
extern u32 SLIDE_KICK_VOICE_IDS[2];
extern Fix12s CHAR_JUMP_VEL_Y_MULTIPLIER[Player::NUM_CHARACTERS];
extern Fix12s CHAR_SWIM_SPEED_MULTIPLIER[Player::NUM_CHARACTERS];
extern u32 ON_WALL_ANIM_IDS[3];
extern Fix12s CHAR_HORZ_SPEED_MULTIPLIER[Player::NUM_CHARACTERS];
extern Fix12i CRAZED_CRATE_VEL_Y[3];
...
extern u32 DASH_VOICE_IDS[4];
extern Fix12i CHAR_CARRY_LIGHT_HORZ_SPEED[Player::NUM_CHARACTERS];
extern Fix12i CHAR_CARRY_HEAVY_HORZ_SPEED[Player::NUM_CHARACTERS];
extern Fix12i CHAR_WATER_RISE_SINK_SPEED_MULTIPLIER[Player::NUM_CHARACTERS];
extern Fix12i PLAYER_SCALE_STEPS[4];
extern u8 ENTRANCE_MODE_TO_STATE[16];
extern u32 HOLD_HEAVY_ANIM_IDS[6];
...
extern u8 HURT_START_GET_UP_ANIM_FRAMES[6];
extern u8 FALL_DURING_HURT_ANIM_START_FRAMES[2];
extern u32 SWIM_DAMAGE_ANIM_IDS[2];
extern u32 STUCK_IN_GROUND_INIT_ANIM_IDS[3];
extern u32 STUCK_IN_GROUND_WAIT_ANIM_IDS[3];
extern u32 STUCK_IN_GROUND_END_ANIM_IDS[3];
extern Vector3 ENDLESS_STAIRS_WARP_OFFSET;
extern Fix12i JUMP_SEQUENCE_VEL_Y[3];
extern u32 JUMP_SEQUENCE_ANIM_ID[3];
extern u32 JUMP_SEQUENCE_LAND_ANIM_ID[3];
