...
extern "C"
{
	...
	s64 Vec3_DistSquaredRaw(const Vector3& v0, const Vector3& v1) __attribute__((pure));
...
struct Vector3
{
	...
	Fix12l   DistSquared (const Vector3& v) const { return {Vec3_DistSquaredRaw(*this, v), as_raw}; }
