...
extern Fix12s JUMP_SPEED_CHAR_MULTIPLIERS[NUM_CHARACTERS];
extern Fix12s SWIM_SPEED_CHAR_MULTIPLIERS[NUM_CHARACTERS];
extern u32 ON_WALL_ANIMS[3];
extern Fix12s HORZ_SPEED_CHAR_MULTIPLIERS[NUM_CHARACTERS];
extern Fix12i CRAZED_CRATE_VERT_SPEEDS[3];
extern Fix12i CRAZED_CRATE_HORZ_SPEEDS[3];
extern u32 DASH_VOICES[4];
extern Fix12i CARRY_LIGHT_HORZ_SPEEDS[NUM_CHARACTERS];
extern Fix12i CARRY_HEAVY_HORZ_SPEEDS[NUM_CHARACTERS];
extern Fix12i WATER_RISE_SINK_SPEED_CHAR_MULTIPLIERS[NUM_CHARACTERS];
...
extern "C"
{
	...
	u32 CountStarsCollectedInCourseToDisplay(u32 courseID);
...
static_assert(NUM_CHARACTERS == 4, "NUM_CHARACTERS is incorrect!");